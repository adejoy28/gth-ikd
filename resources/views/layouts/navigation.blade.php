{{-- <nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed w-full z-50 top-0 start-0">
...
{{-- 
 <ul class="space-y-2 font-medium mt-3"> --}}
        <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
         ...
         <x-nav-link href="#" :active="request()->routeIs('laptops.index')">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Laptops</span>
         </x-nav-link>
         {{-- <x-nav-link href="{{ route('borrow-requests.index') }}" :active="request()->routeIs('borrow-requests.index')">
        ...
        <x-nav-link href="#" :active="request()->routeIs('borrow-requests.index')">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Borrow Requests</span>
        </x-nav-link>
        <!-- Authentication -->
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <x-nav-link :href="route('logout')"
               onclick="event.preventDefault();
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Sign Out of</span>
            </x-nav-link>
        </form>
        {{-- <x-nav-link href="#" :active="request()->routeIs('borrow-requests.index')">
               <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
